  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      <main className="container mx-auto py-8 md:py-16">
        <h1 className="text-white px-3 text-center text-5xl md:text-8xl font-bold">my name is xy</h1>
        <CardContainer className="mb-20">
          <CardBody className="relative group/card hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] bg-black border-white/[0.2] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
            ...
            <CardItem as="p" translateZ="60" className="font-sans text-sm max-w-sm mt-2 text-gray-400">
        ...
        <motion.section className="flex flex-col gap-6 items-center">
          <div className="flex flex-col md:flex-row justify-center align-baseline gap-6 md:gap-28 max-w-[800px] px-4 md:px-0">
            <h1 className="text-white text-3xl md:text-5xl font-bold tracking-tight leading-tight text-center md:text-left">
              My Glorious Projects.
            </h1>
            <div className="flex flex-col justify-end">
              <h2 className="text-gray-400 text-lg md:text-xl leading-[1.2] tracking-[-0.015em] text-center md:text-left">
          ...
          >
            {projects.map((project, key) => (
              ...
              >
                <PinContainer href={project.link} title={project.link} containerClassName="h-72">
                  <Card className="w-72 h-64">
                    <CardHeader className="p-4">
                      <CardTitle className="text-xl md:text-3xl tracking-tight">{project.title}</CardTitle>
                    </CardHeader>
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-white text-3xl md:text-5xl font-bold">Certifications</h1>
            <h2 className="text-gray-400 text-lg md:text-xl mt-2">Milestones in my journey</h2>
          </div>
          <motion.div
                    ...
                    <CardContent className="p-0 h-full">
                      <div className="relative h-48 w-full">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          ...
                          <p className="text-white font-sans font-semibold text-center text-sm">{cert.description}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        >
          <div className="flex flex-col md:flex-row justify-center align-baseline gap-6 md:gap-28 max-w-[800px] px-4 md:px-0">
            <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight text-center md:text-left">
              Blogs
            </h1>
          </div>
        ...
        <motion.section
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-white text-3xl md:text-5xl font-bold text-center">Testimonials</h1>
          <h2 className="text-gray-400 text-lg md:text-xl text-center">Hear from the best.</h2>
          <Testimonials />
        </motion.section>
      </main>
    </div>
